 ...
 * @author aluno
 */
public class BuscaBairro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panelSearch.add(buttonFilter, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 0, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaBairro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscaBairro().setVisible(true);
            }
        });
    }
